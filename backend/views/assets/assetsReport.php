...
<div style="text-align:center;">
                ...
                <h4 style="font-family: calibri;">ASSETS REPORT</h4>
</div>
...
<thead>
    <tr>
        ...
        <th style="border: 1px solid #ddd;padding: 8px;padding-top: 6px;padding-bottom: 6px;text-align: left;background-color: #04AA6D;color: white;">Owner</th>
...
foreach ($assets as $asset) {
    ...
    <tr>
        ...
        <td style="font-family: calibri;border: 1px solid #ddd;padding: 8px"><?=  Html::encode($asset->barcode) ?></td>
        ...
        <td style="font-family: calibri;border: 1px solid #ddd;padding: 8px"><?=  Html::encode($asset->Asset_Particular) ?></td>
        <td style="font-family: calibri;border: 1px solid #ddd;padding: 8px"><?=  Html::encode($asset->condition) ?></td>
        <td style="font-family: calibri;border: 1px solid #ddd;padding: 8px"><?php
        //   ($asset->status == 1) ? 'Availabe' : 'Not available' 
          if ($asset->status == 1) {
            echo 'Available';
         }
